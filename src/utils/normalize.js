...
exports.getProdModules = exports.getEntryForFunction = exports.normalizeBuildOptions = exports.getSourceRoot = exports.getProjectRoot = exports.assignEntriesToFunctionsFromServerless = void 0;
...
function assignEntriesToFunctionsFromServerless(options, root) {
    devkit_1.logger.info('getting all functions');
...
exports.getEntryForFunction = getEntryForFunction;
...
const getEntryExtension = (fileName, serverless, servicePath) => {
    ...
    if (_.isEmpty(files)) {
        ...
        throw new serverless.classes.Error(`No matching handler found for '${fileName}' in '${servicePath}'. Check your service definition.`);
    }
